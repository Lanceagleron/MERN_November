...
const teacherInstance2 = new Teacher("Niel", "Mos", 10);
...
const studentInstance3 = new Student("Lance", "Agleron", ["laughing"]);

const lectureInstance1 = new Lecture("OOP Intro", "zoomlink.com/pwd=dsadsadsdsad", teacherInstance1, [studentInstance1, studentInstance2, studentInstance3]);
...
console.log(studentInstance1.money) // 50
console.log(studentInstance2.money) // 150
